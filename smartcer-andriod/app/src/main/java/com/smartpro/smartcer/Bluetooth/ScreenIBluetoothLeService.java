 ...
 */
public class ScreenIBluetoothLeService extends Service {
    private final static String TAG = ScreenIBluetoothLeService.class.getSimpleName();
    ...
    public final static String SCREEN_I_DEVICE_NAME = "Screen I";   //HMSoft

    public final static String ACTION_SCREEN_I_GATT_CONNECTED = "com.smartpro.screenI.bluetooth.le.ACTION_GATT_CONNECTED";
    public final static String ACTION_SCREEN_I_GATT_DISCONNECTED = "com.smartpro.screenI.bluetooth.le.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_SCREEN_I_GATT_SERVICES_DISCOVERED = "com.smartpro.screenI.bluetooth.le.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_SCREEN_I_DATA_AVAILABLE = "com.smartpro.screenI.bluetooth.le.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA_SCREEN_I = "com.smartpro.screenI.bluetooth.le.EXTRA_DATA";
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                intentAction = ACTION_SCREEN_I_GATT_CONNECTED;
                ...
                intentAction = ACTION_SCREEN_I_GATT_DISCONNECTED;
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                broadcastUpdate(ACTION_SCREEN_I_GATT_SERVICES_DISCOVERED);
            } else {
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
                                         ...
                                         int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                broadcastUpdate(ACTION_SCREEN_I_DATA_AVAILABLE, characteristic);
            }
        }
    ...
    private void broadcastUpdate(final String action, final BluetoothGattCharacteristic characteristic) {
        ...
        if (characteristic.getUuid().toString().equalsIgnoreCase(BluetoothLeGattAttributes.SMARTPRO_RX_TX_CHARACTERISTIC))  {
            ...
            if (data != null && data.length > 0) {
                ...
                intent.putExtra(EXTRA_DATA_SCREEN_I,String.format("%s", new String(data)));
                intent.putExtra(BluetoothDevice.EXTRA_DEVICE, mBluetoothDeviceName);
            }
        }
        sendBroadcast(intent);
    ...
    public class LocalBinder extends Binder {
        public ScreenIBluetoothLeService getService() {
            return ScreenIBluetoothLeService.this;
        }
    }
