 ...
 */
public class ReaderIIBluetoothLeService extends Service {
    private final static String TAG = ReaderIIBluetoothLeService.class.getSimpleName();
    ...
    public final static String READER_II_DEVICE_NAME = "Reader I";

    public final static String ACTION_READER_II_GATT_CONNECTED = "com.smartpro.readerII.bluetooth.le.ACTION_GATT_CONNECTED";
    public final static String ACTION_READER_II_GATT_DISCONNECTED = "com.smartpro.readerII.bluetooth.le.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_READER_II_GATT_SERVICES_DISCOVERED = "com.smartpro.readerII.bluetooth.le.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_READER_II_DATA_AVAILABLE = "com.smartpro.readerII.bluetooth.le.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA_READER_II = "com.smartpro.readerII.bluetooth.le.EXTRA_DATA";
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                intentAction = ACTION_READER_II_GATT_CONNECTED;
                ...
                intentAction = ACTION_READER_II_GATT_DISCONNECTED;
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                broadcastUpdate(ACTION_READER_II_GATT_SERVICES_DISCOVERED);
            } else {
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
                                         ...
                                         int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                broadcastUpdate(ACTION_READER_II_DATA_AVAILABLE, characteristic);
            }
        }
    ...
    private void broadcastUpdate(final String action, final BluetoothGattCharacteristic characteristic) {
        ...
        if (characteristic.getUuid().toString().equalsIgnoreCase(BluetoothLeGattAttributes.SMARTPRO_RX_TX_CHARACTERISTIC))  {
            ...
            if (data != null && data.length > 0) {
                ...
                intent.putExtra(EXTRA_DATA_READER_II,String.format("%s", new String(data)));
                intent.putExtra(BluetoothDevice.EXTRA_DEVICE, mBluetoothDeviceName);
            }
        }
        sendBroadcast(intent);
    ...
    public class LocalBinder extends Binder {
        public ReaderIIBluetoothLeService getService() {
            return ReaderIIBluetoothLeService.this;
        }
    }
